...
Instructions for a new player :
	...
	3. Play Offline Button : Allows the player to play the game alone against computer player(s).

	4. Host Button : Allows the player to host the game , after he/she provides
	a valid port number.

	5. Player2 Button : Allows the second player to connect to a hosted game after he provides the port number and IP address of machine hosting the game.

	6. Player3 Button : Allows the third player to connect to a hosted game after he provides the port number and IP address of machine hosting the game.

	7. Player4 Button : Allows the fourth(and last) player to connect to a hosted game after he provides the port number and IP address of machine hosting the game.

	8. Quit Game button : Closes the game window.
